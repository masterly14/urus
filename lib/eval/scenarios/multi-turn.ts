...
export const MULTI_TURN_SCENARIOS: EvalScenario[] = [
  {
    ...
    buyerInstructions: "Ya dijiste que te gusta Salamanca. Ahora dices que la segunda (eval-002, ático Chamartín) también te gusta, 'esa del garaje y piscina'. Refiérete al historial.",
    expectedOutcome: {
  ...
  },
  {
    ...
    buyerInstructions: "Antes te gustaba el dúplex (eval-003) pero ahora lo has pensado mejor y prefieres la casa de Pozuelo (eval-005, la última). Cambia de opinión.",
    expectedOutcome: {
