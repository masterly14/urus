...
There is also an API calls collection to import in Postman created with the most usual API calls:

Obtén el enlace con clave de acceso desde la documentación oficial de Signaturit o Postman; no incluyas `access_key` ni tokens en el repositorio.
