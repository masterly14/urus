                  ...
                  {filtered.map((p) => (
                    <tr key={p.codigo} className="hover:bg-accent/20 transition-colors">
                      <td className="px-4 py-3">
                        <Link href={`/pricing/informe/${p.codigo}`} className="text-xs font-mono font-bold text-secondary hover:underline">
                          {p.codigo}
                        </Link>
                      </td>
                      <td className="px-4 py-3">
                        <Link href={`/pricing/informe/${p.codigo}`} className="text-sm font-medium hover:text-secondary transition-colors">
