...
> = {
  borrador: {
    ...
    icon: FileText,
    bgClass:
      "bg-[var(--urus-info)]/8 text-[var(--urus-info)] border-[var(--urus-info)]/20",
  },
  revision: {
    ...
    icon: AlertCircle,
    bgClass:
      "bg-[var(--urus-warning)]/8 text-[var(--urus-warning)] border-[var(--urus-warning)]/20",
  },
  enviado: {
    ...
    icon: Send,
    bgClass:
      "bg-[var(--urus-gold)]/8 text-[var(--urus-gold)] border-[var(--urus-gold)]/20",
  },
  firmado: {
    label: "Firmado",
    ...
    icon: CheckCircle2,
    bgClass:
      "bg-[var(--urus-success)]/8 text-[var(--urus-success)] border-[var(--urus-success)]/20",
  },
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {(
          Object.entries(estadoConfig) as [
            EstadoContrato,
            (typeof estadoConfig)[EstadoContrato],
          ][]
        ).map(([key, cfg]) => {
        ...
        <CardContent className="p-4">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex gap-1">
              {(
                ["all", "borrador", "revision", "enviado", "firmado"] as const
              ).map((e) => {
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border/30">
                  ...
                  <th className="text-center px-4 py-3 text-[10px] text-muted-foreground uppercase tracking-wider font-medium">
                    Versión
                  </th>
                  <th className="text-center px-4 py-3 text-[10px] text-muted-foreground uppercase tracking-wider font-medium">
                    Estado
                  ...
                  return (
                    ...
                    >
                        ...
                        <Badge
                          ...
                          className={`text-[10px] ${
                            c.tipo === "arras"
                              ...
                              : "border-[var(--urus-info)]/30 text-[var(--urus-info)]"
                          }`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <div className="text-xs">
                          <p className="font-medium">
                            {c.variables.comprador as string}
                          </p>
                          <p className="text-muted-foreground text-[10px]">
                            ↔ {c.variables.vendedor as string}
                          </p>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <Badge
                          variant="outline"
                          className={`text-[10px] gap-1 ${cfg.bgClass}`}
                        >
                      ...
                      <td className="px-4 py-3 text-center">
                        <span className="text-xs font-mono font-medium">
                          {(c.variables.precio as number).toLocaleString(
                            "es-ES",
                          )}{" "}
                          €
                        </span>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-1">
                          <Link href={`/platform/legal/contratos/${c.id}`}>
                            <button
                              className="p-1.5 rounded-lg hover:bg-accent/40 transition-all"
                              title="Ver contrato"
                            >
                          ...
                          {c.estado === "revision" && (
                            <button
                              className="p-1.5 rounded-lg hover:bg-[var(--urus-gold)]/20 transition-all"
