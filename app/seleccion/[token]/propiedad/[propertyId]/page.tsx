          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {hasMap ? (
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div className="mt-5 overflow-hidden rounded-xl border border-slate-200 shadow-inner bg-slate-100">
                  <StaticMapImage
        ...
        <nav className="mt-12 flex items-center justify-between border-t border-slate-200 pt-8 gap-4">
          {prevProperty ? (
            <Link
              ...
              className="flex-1 flex items-center gap-3 p-4 rounded-xl border border-slate-200 bg-white hover:border-blue-300 hover:shadow-md transition-all group"
            >
          ...
          {nextProperty ? (
            <Link
              ...
              className="flex-1 flex items-center justify-end gap-3 p-4 rounded-xl border border-slate-200 bg-white hover:border-blue-300 hover:shadow-md transition-all group text-right"
            >
