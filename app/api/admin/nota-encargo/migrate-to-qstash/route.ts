/**
 * Endpoint admin one-shot: migrar las `NotaEncargoSession` con jobs pendientes
 * en `job_queue` (RECORDATORIO / CHECK_CONFIRMACION / ENVIAR_FORMULARIO /
 * MATCHING_CHECK) a schedules de QStash.
 *
 * Pensado para ejecutarse desde el entorno de Vercel tras el cambio de
 * arquitectura. Las sesiones cuya fecha objetivo ya pasó se omiten (`skipped_past`):
 * para esos rescates puntuales usar `scripts/force-send-nota-encargo.ts`.
 *
 * Autenticación:
 *   - Firma Upstash, o
